...
const Dashboard = () => {
    ...
    const user = <>
        ...
        <Link className=' hover:bg-rose-500 py-1' to='/dashboard/listofsellers' >List of Seller</Link>
        <Link className=' hover:bg-rose-500 py-1' to='/dashboard/reporteditems' >Reported Item</Link>
    </>;
